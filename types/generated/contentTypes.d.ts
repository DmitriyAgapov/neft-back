...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    category_parent: Schema.Attribute.Relation<
      'manyToOne',
    ...
    > &
      Schema.Attribute.Private;
    product_hydraulics: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiKonfiguracziyaSajtaKonfiguracziyaSajta
  extends Struct.SingleTypeSchema {
  collectionName: 'konfiguracziya_sajtas';
  info: {
    displayName: '\u041A\u043E\u043D\u0444\u0438\u0433\u0443\u0440\u0430\u0446\u0438\u044F \u0441\u0430\u0439\u0442\u0430';
    pluralName: 'konfiguracziya-sajtas';
    singularName: 'konfiguracziya-sajta';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emails: Schema.Attribute.Component<'contacts.emails', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::konfiguracziya-sajta.konfiguracziya-sajta'
    > &
      Schema.Attribute.Private;
    logo: Schema.Attribute.Component<'logo.logos', false>;
    Phones: Schema.Attribute.Component<'contacts.phones', true>;
    publishedAt: Schema.Attribute.DateTime;
    slogan: Schema.Attribute.String;
    Social: Schema.Attribute.Component<'contacts.social', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    website_name: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiProductHydraulicProductHydraulic
  extends Struct.CollectionTypeSchema {
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dvigatel: Schema.Attribute.JSON &
      ...
      > &
      Schema.Attribute.DefaultTo<'["power-22", "power-11", "power-75", "power-55"]'>;
    Feature: Schema.Attribute.Component<'layout.option', true>;
    ...
    > &
      Schema.Attribute.Private;
    plotnost: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        'plugin::multi-select.multi-select',
        [
          '\u0414\u0432\u043E\u0439\u043D\u043E\u0435 \u0442\u043E\u0440\u0446\u043E\u0432\u043E\u0435:double',
          '\u041E\u0434\u0438\u043D\u0430\u0440\u043D\u043E\u0435 \u0442\u043E\u0440\u0446\u043E\u0432\u043E\u0435:single',
        ]
      > &
      Schema.Attribute.DefaultTo<'[]'>;
    publishedAt: Schema.Attribute.DateTime;
    rotary: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        'plugin::multi-select.multi-select',
        [
          '\u0410\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438\u0439:auto',
